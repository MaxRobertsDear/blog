...
1.  **Open the source code and start editing!**
    ...
    _Note: You'll also see a second link: _`http://localhost:8000/___graphql`_. This is a tool that can be used to experiment with querying the data. _
...
2.  **`/src`**: This directory will contain all of the code related to what will be seen on the front-end of the site such as your site header or a page template. 
...
6.  **`gatsby-config.js`**: This is the main configuration file for a Gatsby site. This is where information can be specified about the site (metadata) like the site title and description, which Gatsby plugins you’d like to include, etc. (Check out the [config docs](https://www.gatsbyjs.org/docs/gatsby-config/) for more detail).
